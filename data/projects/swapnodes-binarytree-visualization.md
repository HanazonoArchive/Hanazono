...
A JavaFX desktop application that visualizes the binary tree node swapping algorithm. This project allows users to input tree structures and perform depth-based node swaps while viewing animated visual representations of the results.
...
### Complexity
- **Time:** O(N × Q) where N = number of nodes, Q = number of queries
